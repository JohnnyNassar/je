    ...
    @php
        ...
        $steps = [
            ...
            [
                ...
                'items_en' => [
                    'On the product form open the <strong>Variations</strong> section to add options like “Red / M”.',
                    'Each option has its <strong>own stock</strong>, and optionally its own price and image.',
                    'When a product has variations, its total stock is added up from them automatically.',
                    'Leave Variations empty for a simple product with a single price and stock.',
                ],
                'items_ar' => [
                    'في صفحة المنتج افتحي قسم <strong>الخيارات (Variations)</strong> لإضافة خيارات مثل «أحمر / وسط».',
                    'كل خيار له <strong>كميته الخاصة</strong>، ويمكن أن يكون له سعر وصورة خاصة به.',
                    'عندما يكون للمنتج خيارات، يتم حساب إجمالي الكمية منها تلقائياً.',
