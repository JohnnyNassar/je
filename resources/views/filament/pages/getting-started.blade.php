    ...
    @php
        ...
        $steps = [
            ...
            [
                ...
                'items_en' => [
                    'On the product form open the <strong>Variations</strong> section and click <em>“Add a variation”</em> for each version you sell.',
                    'Each variation is <strong>one combination</strong>. To combine attributes, put them all in the name separated by “ / ” — e.g. <strong>“Red / M / 50cm”</strong> for colour + size + dimension.',
                    'Add one row per combination you actually stock (e.g. “Rectangular” and “Hexagonal”, or “Red / L” and “Blue / M”).',
                    'Each variation has its <strong>own stock</strong>, and optionally its own <strong>price</strong> and <strong>photo</strong> — leave price or photo blank to reuse the product’s.',
                    ...
                    'On the website customers pick a variation with buttons, and the photo and price update to match; sold-out ones are shown crossed out.',
                    'Leave Variations empty for a simple product with a single price and stock.',
                ],
                'items_ar' => [
                    'في صفحة المنتج افتحي قسم <strong>الخيارات (Variations)</strong> واضغطي <em>«إضافة خيار»</em> لكل نسخة تبيعينها.',
                    'كل خيار هو <strong>تركيبة واحدة</strong>. لدمج أكثر من صفة، اكتبيها كلها في الاسم مفصولة بـ « / » — مثل <strong>«أحمر / وسط / ٥٠سم»</strong> للّون والمقاس والأبعاد.',
                    'أضيفي صفاً لكل تركيبة متوفرة فعلاً (مثل «مستطيل» و«سداسي»، أو «أحمر / كبير» و«أزرق / وسط»).',
                    'كل خيار له <strong>كميته الخاصة</strong>، ويمكن أن يكون له <strong>سعر</strong> و<strong>صورة</strong> خاصة — اتركي السعر أو الصورة فارغين لاستخدام سعر وصورة المنتج.',
                    'لا تعدّلي حقل <strong>الكمية (Stock)</strong> الرئيسي عند وجود خيارات — يُحسب الإجمالي منها تلقائياً.',
                    'في الموقع يختار العملاء الخيار بالأزرار، وتتحدّث الصورة والسعر تلقائياً؛ والخيارات غير المتوفرة تظهر مشطوبة.',
                    'اتركي قسم الخيارات فارغاً للمنتج البسيط ذي السعر والكمية الواحدة.',
                ],
            ],
            [
                'icon' => '🗂️',
