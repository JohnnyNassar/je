<x-layouts.shop>
    ...
    @auth('web')
        <div class="mb-4 inline-flex items-center gap-2 rounded-md bg-gray-100 px-2.5 py-1 text-xs text-gray-500">
            ...
            <span class="font-medium">{{ __('Product #:n', ['n' => $product->id]) }}</span>
            <span class="text-gray-400">· {{ __('visible to staff only') }}</span>
        </div>
    @endauth
