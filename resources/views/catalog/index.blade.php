    ...
    @if (($featured ?? collect())->isNotEmpty())
        <section class="mb-8">
            <div class="flex items-center gap-3 mb-4">
                <span class="inline-flex items-center justify-center w-8 h-8 rounded-md bg-amber-100 text-amber-600">
                   ...
                   class="group flex flex-col bg-white border border-gray-200 rounded-xl overflow-hidden hover:shadow-card-hover hover:border-gray-300 transition-all duration-200">
                    <div class="relative aspect-square overflow-hidden bg-gray-100">
                        ...
                        @elseif ($product->stock <= 3)
                            <span class="absolute top-2 end-2 inline-flex items-center rounded-md bg-amber-100 text-amber-700 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wider">
